              ...
              selectedDateSessions.map((session: any) => {
                ...
                return (
                  <SessionsPanel
                    key={session.id}
                    className={clsx(
                      "group cursor-pointer p-4 transition-all hover:-translate-y-0.5 hover:ring-1 hover:ring-zinc-200 dark:hover:ring-zinc-700 sm:p-5",
                      isActive && "ring-2 ring-primary/20"
                    )}
                    onClick={() => handleSessionClick(session)}
                  >
                    <div className="flex min-h-[9.5rem] flex-col gap-4">
                      ...
                      <div className="mt-auto grid grid-cols-2 gap-2 border-t border-zinc-100 pt-3 dark:border-zinc-800">
                        <div className="rounded-lg bg-zinc-50 px-2.5 py-2 dark:bg-zinc-800/60">
                          <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-400">Time</p>
                          <p className="mt-1 flex items-center gap-1.5 text-xs font-semibold text-zinc-700 dark:text-zinc-200">
                            <IconClock className="h-3.5 w-3.5 text-zinc-400" stroke={1.75} />
                        ...
                        <div className="min-w-0 rounded-lg bg-zinc-50 px-2.5 py-2 dark:bg-zinc-800/60">
                          <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-400">Host</p>
                          <p className="mt-1 flex min-w-0 items-center gap-1.5 truncate text-xs font-semibold text-zinc-700 dark:text-zinc-200">
                            <IconUserCircle className="h-3.5 w-3.5 shrink-0 text-zinc-400" stroke={1.75} />
